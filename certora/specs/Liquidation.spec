...
//------------------------------- RULES TEST START ----------------------------------
    ...
    rule liquidateReverts(env e) {
        ...
        //VALUES BEFORE
        address liquidator = actualCallerCheckController(e); //i: onBehalfOf
        ...
        mathint finalYieldBalance = liability == 0 ? 0 : repayAssets != max_uint256 ? yieldBalanceCapped : yieldBalanceCalculated;
        ...
        // //assert12: minYieldBalance > finalYieldBalance, the function reverts //@audit does not work, check why
        // assert(to_mathint(minYieldBalance) > finalYieldBalance => reverted, "minYieldBalance is higher than the finalYieldBalance, but the function did not revert");
